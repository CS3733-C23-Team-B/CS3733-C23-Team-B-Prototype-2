...
public class Board extends JPanel {
  ...
  private Timer timer;
  private String message = "Game Over... Get Back To Work";
  private Ball ball;
  ...
  private void gameFinished(Graphics2D g2d) {
    ...
    g2d.setFont(font);
    g2d.drawString(
        message, (Commons.WIDTH - fontMetrics.stringWidth(message)) / 2, Commons.WIDTH / 2);
  }
  ...
  private void checkCollision() {
    ...
    for (int i = 0, j = 0; i < Commons.N_OF_BRICKS; i++) {
      ...
      if (j == Commons.N_OF_BRICKS) {
        ...
        message = "You Win! Get back to work";
        stopGame();
      }
    }
